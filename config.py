...
class Config:
    def __init__(self):
        ...
        self.PROPOSAL_TRACE_DB_PATH = os.getenv('PROPOSAL_TRACE_DB_PATH')
        self.PROPOSAL_TRACE_BUSY_TIMEOUT_MS = _get_int_env('PROPOSAL_TRACE_BUSY_TIMEOUT_MS', 5000)
        self.PROPOSAL_TRACE_API_KEY = os.getenv('PROPOSAL_TRACE_API_KEY')
